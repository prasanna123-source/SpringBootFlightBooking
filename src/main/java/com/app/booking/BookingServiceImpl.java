...
//		Airline flight = flightRepo.findById(flightID).orElse(null);
//		logger.debug(">>>>>>>>>>>>>>>>>> Flight = " + flight);
//
//		List<Airline> nextFlights = flightRepo.findByDepartureAndDepartureDateGreaterThan(flight.getArrival(),
//				flight.getArrivalDate());
//		Airline nextFlight = CollectionUtils.isEmpty(nextFlights) ? null : nextFlights.get(0);
//		logger.debug(" CCCCCCCCCCCC >>>>>>>>>>>>>>>>>> nextFlight = " + nextFlight);
//
//		FlightBooking booking = new FlightBooking();
//		booking.setPassenger(passenger);
//
//		Set<Airline> flights = new HashSet<>(2);
//		flights.add(flight);
